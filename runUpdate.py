...
for line in fp:
    ...
    if( xFlag==1 and len(l[2]) < 14):
        numofZeros = 14 - len(l[2])
        zeroAdd = ""
        for n in range(0,numofZeros):
            zeroAdd = zeroAdd + "0"
        oxStr = "0x"
        endStr = l[2][2:]
        memAddy = oxStr+zeroAdd+endStr
    elif( xFlag==0 and len(l[2]) < 12):
        numofZeros = 12 - len(l[2])
        zeroAdd = ""
        for n in range(0,numofZeros):
            zeroAdd = zeroAdd + "0"
        memAddy = zeroAdd + l[2]
